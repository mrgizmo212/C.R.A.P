...
function buildCursorPrompt({ submissionId, folder, payload, savedImages, summaryPath, manifestPath, aiReport }) {
  ...
  return [
    ...
    "",
    "Skill to invoke: `look-at-this-crap`",
    "",
    "Use this prompt in Cursor after a C.R.A.P. review folder has been saved.",
    "If the project skill is available, invoke `look-at-this-crap` before analyzing the evidence.",
    "",
    "```text",
    "You are reviewing evidence captured with Codebase Review Action Planner (C.R.A.P.).",
    "Invoke the look-at-this-crap skill now if it is available.",
    "",
    "What happened:",
    ...
    "",
    "Your task:",
    "0. Invoke `look-at-this-crap` if that skill is available in this workspace.",
